...
namespace Task2.Controllers
{
    public class BookingsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("BookingId,RoomId,StaffId,UserId,GuestName,NumberOfGuests,BookingDate,CheckInDate,CheckOutDate,CreatedAt,UpdatedAt")] Booking booking)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BookingId,RoomId,StaffId,UserId,GuestName,NumberOfGuests,BookingDate,CheckInDate,CheckOutDate,CreatedAt,UpdatedAt")] Booking booking)
        {
