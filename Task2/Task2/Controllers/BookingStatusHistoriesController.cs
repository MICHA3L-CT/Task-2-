...
namespace Task2.Controllers
{
    public class BookingStatusHistoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("BookingStatusHistoryId,BookingId,OldStatus,NewStatus,ChangedAt,ChangedBy")] BookingStatusHistory bookingStatusHistory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BookingStatusHistoryId,BookingId,OldStatus,NewStatus,ChangedAt,ChangedBy")] BookingStatusHistory bookingStatusHistory)
        {
