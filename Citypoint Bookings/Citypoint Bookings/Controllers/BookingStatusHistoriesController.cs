...
namespace Citypoint_Bookings.Controllers
{
    public class BookingStatusHistoriesController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["ChangedByUserId"] = new SelectList(_context.Users, "Id", "Id");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("BookingStatusHistoryId,BookingId,OldStatus,NewStatus,ChangedAt,ChangedByUserId")] BookingStatusHistory bookingStatusHistory)
        {
            ...
            ViewData["ChangedByUserId"] = new SelectList(_context.Users, "Id", "Id", bookingStatusHistory.ChangedByUserId);
            return View(bookingStatusHistory);
        }
